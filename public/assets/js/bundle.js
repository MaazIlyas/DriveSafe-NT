...
},{"./dom/data.js":5,"./dom/event-handler.js":6}],3:[function(require,module,exports){
/*!
...
},{"./base-component.js":2,"./dom/event-handler.js":6}],4:[function(require,module,exports){
/*!
...
},{"./base-component.js":2,"./dom/data.js":5,"./dom/event-handler.js":6,"./dom/manipulator.js":7,"./dom/selector-engine.js":8}],5:[function(require,module,exports){
/*!
...
},{"./base-component.js":2,"./dom/event-handler.js":6,"./dom/manipulator.js":7,"./dom/selector-engine.js":8,"@popperjs/core":1}],10:[function(require,module,exports){
/*!
...
},{"./base-component.js":2,"./dom/event-handler.js":6,"./dom/manipulator.js":7,"./dom/selector-engine.js":8}],11:[function(require,module,exports){
/*!
...
},{"./base-component.js":2,"./dom/event-handler.js":6,"./dom/manipulator.js":7,"./dom/selector-engine.js":8}],12:[function(require,module,exports){
...
// window.bootstrap.Popover = require('bootstrap/js/dist/popover');
...
},{"@popperjs/core":1,"bootstrap/js/dist/base-component":2,"bootstrap/js/dist/button":3,"bootstrap/js/dist/collapse":4,"bootstrap/js/dist/dropdown":9,"bootstrap/js/dist/offcanvas":10,"bootstrap/js/dist/scrollspy":11}]},{},[13]);
...
function markStar(item) {
    ...
    for (var i = 0; i < 5; i++) {
        if (i < count) {
            if (document.getElementById((i + 1) + subid).classList.contains("fa-regular")) {
                ...
                document.getElementById((i + 1) + subid).classList.add("fas");
            }
        } else {
            if (document.getElementById((i + 1) + subid).classList.contains("fas")) {
                document.getElementById((i + 1) + subid).classList.remove("fas");
    ...
    document.getElementById("rating-input").setAttribute("value", count);
}
